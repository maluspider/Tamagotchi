...
// PinEntryScreen erreichbar. Sechs Zeilen: Tageslimit, Bonus-Zeit,
// Nachtmodus an/aus, Uhrzeit einstellen, PIN aendern, Web-Sync starten
// (Abschnitt 12, Phase 5). Eine UI zum Anpassen der Nachtmodus-Start-/
// Endzeit ist eine bewusste Vereinfachung nicht umgesetzt (siehe Abschnitt
// 16, offener Punkt); Default 20-7 Uhr bleibt fest, bis diese UI ergaenzt
// wird.
...
private:
    ...
    static constexpr int kRow0Y = 34;
    static constexpr int kRow1Y = 66;
    static constexpr int kRow2Y = 98;
    static constexpr int kRow3Y = 130;
    static constexpr int kRow4Y = 162;
    static constexpr int kRow5Y = 194;
