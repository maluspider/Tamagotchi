...
|---|---|---|
| `/profile.json` | `profil` (Name, Alter, Klasse, Geräte-ID) + `guard` (gehashter Eltern-PIN) + `wecker` (Alarmzeit/an-aus) + `aussehen` (Hautfarbe/Haarfarbe/Kleidungsfarbe-Indizes, Abschnitt 4/9) | selten (i. d. R. einmalig bei Ersteinrichtung bzw. bei Wecker-/Aussehen-Änderung) |
